...
const UI_TRANSLATIONS = {
  en: {
    ...
    classroomExamplesKicker: "Examples Gallery",
    classroomExamplesTitle: "Start from ready worksheet examples instead of a blank page",
    classroomExamplesSubtitle: "Choose a classroom example, apply it to the form, then adjust the details before generating the worksheet.",
    ...
    actionsIntro: "Generate the worksheet, save it, or export the printable PDF from one clear place.",
    advancedSettings: "Advanced Settings",
    advancedSettingsIntro: "Open this section for print details, teacher mode, school defaults, and secondary worksheet tools.",
    advancedPedagogySection: "Worksheet Controls",
    advancedPedagogyIntro: "Use these only when you need a specific operation, teacher mode, or manual fine-tuning.",
    secondaryToolsSection: "Secondary Tools",
    secondaryToolsIntro: "Keep duplicate or occasional actions here so the main workflow stays simple.",
    ...
    template: "Template",
    printInfoSection: "Print Information",
    printInfoIntro: "Add only the printed classroom details you want to appear on the worksheet and PDF.",
    ...
    exampleTemplateApplied: "Template applied. You can edit the information before generating the worksheet.",
  ...
  fr: {
    ...
    classroomExamplesKicker: "Galerie d'exemples",
    classroomExamplesTitle: "Commencez avec des exemples de fiches prêts à l’emploi",
    classroomExamplesSubtitle: "Choisissez un exemple de classe, appliquez-le au formulaire, puis ajustez les informations avant de générer la fiche.",
    ...
    actionsSection: "Actions",
    actionsIntro: "Générez la fiche, enregistrez-la ou exportez le PDF imprimable depuis un seul endroit clair.",
    advancedSettings: "Paramètres avancés",
    advancedSettingsIntro: "Ouvrez cette section pour les détails d'impression, le mode enseignant, les réglages de l'école et les outils secondaires.",
    advancedPedagogySection: "Contrôles de la fiche",
    advancedPedagogyIntro: "Utilisez-les seulement si vous avez besoin d’une opération précise, d’un mode enseignant ou d’un réglage manuel.",
    secondaryToolsSection: "Outils secondaires",
    secondaryToolsIntro: "Gardez ici les actions dupliquées ou occasionnelles pour que le flux principal reste simple.",
    printInfoSection: "Informations d'impression",
    printInfoIntro: "Ajoutez uniquement les informations d'impression que vous souhaitez afficher sur la fiche et le PDF.",
    ...
    exampleTemplateApplied: "Modèle appliqué. Vous pouvez modifier les informations avant de générer la fiche.",
    workflow: "Flux {label}",
