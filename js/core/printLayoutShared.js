...
export function getLocalizedHeaderMetrics(baseMetrics, language = "en") {
  ...
  return {
    ...baseMetrics,
    schoolGap: scaleMetric(baseMetrics.schoolGap, 1.14, baseMetrics.schoolGap + 0.3),
    titleGap: scaleMetric(baseMetrics.titleGap, 1.08, baseMetrics.titleGap + 0.32),
    descriptorLineUnit: scaleMetric(baseMetrics.descriptorLineUnit, 1.05, baseMetrics.descriptorLineUnit + 0.08),
    descriptorMinHeight: scaleMetric(baseMetrics.descriptorMinHeight, 1.08, baseMetrics.descriptorMinHeight + 0.25),
